...
# initialization
st.markdown("<h1 style='text-align: center; text-decoration: underline;'>PoC: custom search engine</h1>",
...
st.info(f"Number of Documents: {len(agenda_out)}")
try:
...
st.info(f"Number of Documents: {len(df_out)}")
try:
