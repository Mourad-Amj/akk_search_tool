...
temp_data=transform(agenda_data) # change final_data to temp_data in case of serialization.
...
# for agenda in final_data: # comment the whole block when serialization 
